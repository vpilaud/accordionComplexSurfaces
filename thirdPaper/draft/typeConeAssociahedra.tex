...
\subjclass[2010]{13F60, 16G20, 18E10, 18E30, 52B11 (primary), 52B35, 05E15 (secondary)}
...
We are investigating in particular graph associahedra~\cite{CarrDevadoss, Postnikov, FeichtnerSturmfels, Zelevinsky}, brick polytopes~\cite{PilaudSantos-brickPolytope, PilaudStump-brickPolytope} and quotientopes~\cite{Reading-latticeCongruences, Reading-CambrianLattices, PilaudSantos-quotientopes}.
...
We now give a more detailed overview of our main results and the structure of the article. In particular, some of the geometric realizations in~\cref{part:geometry} depend on algebraic results whose proves are delayed until~\cref{part:algebra}. The goal of this section is to clarify their logical dependencies, summarized in the schematic diagram depicted at the end. 
...
\tikzset{
  double arrow/.style={
    -latex, line width=3pt, black, % first arrow
    postaction={draw,line width=2pt, white, shorten <= 1,shorten >= 2}, % second arrow
  }
}
\centerline{
\begin{tikzpicture}[every node/.style={inner sep=6, outer sep=8}]
	\node[diamond,aspect=3, text width=5cm, minimum height=1cm, align=center, draw=blue, fill=blue!10, inner sep=-2] (I1) at (0,1.5) {\ref{part:geometry}.\ref{sec:typeCone} -- Simplicial type cone strategy};
	\node[rectangle, draw=black, fill=black!10, align=center, minimum width = 5.3cm, minimum height=1.2cm] (I21) at (-6,-1.5) {\ref{part:geometry}.\ref{subsec:typeConeAsso} -- Toy example \\ Classical associahedra};
	\node[rectangle, draw=orange, fill=orange!10, align=center, text width=5.3cm, minimum width = 5cm, minimum height=1.2cm] (I22) at (0,-1.5) {\ref{part:geometry}.\ref{subsec:typeConeCA} -- Cluster algebras \\ \& generalized associahedra};
	\node[rectangle, draw=green, fill=green!10, align=center, text width=5.3cm, minimum width = 5cm, minimum height=1.2cm] (I23) at (6,-1.5) {\ref{part:geometry}.\ref{subsec:typeConeNKC} -- Gentle algebras \\ \& generalized accordiohedra};
% 	\node[rectangle, draw=red, fill=red!10, align=center, text width=5.4cm] (I24) at (7,0) {\ref{part:geometry}.\ref{subsec:typeConeGA} -- Graphical nested complexes \\ \& graph associahedra};
	\node[ellipse,
% 	rectangle,rounded corners=10, 
	draw=orange, fill=orange!10, align=center, text width=5cm, inner sep=2, minimum height=1cm] (II1) at (-4.5,-4.2) {\ref{part:algebra}.\ref{sec:clusterCategories} -- Cluster categories};
	\node[ellipse,
% 	rectangle,rounded corners=10,
	draw=green, fill=green!10, align=center, text width=5cm, inner sep=0, minimum height=1cm] (II2) at (4.5,-4.2) {\ref{part:algebra}.\ref{sec:extricats} -- Extriangulated categories};
	\draw[decorate, decoration={shape backgrounds, shape=dart, shape size=2mm, shape evenly spread=8}, draw=blue, fill=blue!10] (I1.180) to [bend right, looseness=1.1] node[label={[shift={(-1.6,-1.5)}]\textit{applied to}}]{} (I21.90);
	\draw[decorate, decoration={shape backgrounds, shape=dart, shape size=2mm, shape evenly spread=3}, draw=blue, fill=blue!10] (I1.270) to node[label={[shift={(1,-1.)}]\textit{applied to}}]{} (I22.90);
	\draw[decorate, decoration={shape backgrounds, shape=dart, shape size=2mm, shape evenly spread=8}, draw=blue, fill=blue!10] (I1.360) to [bend left, looseness=1.1] node[label={[shift={(1.6,-1.5)}]\textit{applied to}}]{} (I23.90);
% 	\draw[decorate, decoration={shape backgrounds, shape=dart, shape size=2mm, shape evenly spread=10}, draw=blue, fill=blue!10] (I1.0) to [bend left, looseness=1.1] (I24.90);
% 	\draw[decorate, decoration={markings, mark=at position 0.5 with {\draw [red, ultra thick,-] ++ (-.3,-.3)  -- ( .3, .3); \draw [red, ultra thick,-] ++ (-.3, .3)  -- ( .3,-.3);}}] (I1.0) to [bend left, looseness=1.1] node[label={[shift={(-.4,-1.7)}]not applicable to}]{} (I24.90);
% 	\draw[thick, double distance=2pt, -implies] (I22.270)+(0,-1.3) to node[semithick, right, outer sep=0, pos=0.65]{\textit{used for}} (I22.270)+(0,.15);
% 	\draw[thick, double distance=2pt, -implies] (I23.270)+(0,-1.3) to node[semithick, right, outer sep=0, pos=0.65]{\textit{used for}} (I23.270)+(0,.15);
	\draw[thick, double distance=2pt, -implies, in=270] (I22.270)+(-1.5,-1.2) to node[semithick, right, outer sep=0, pos=0.55]{\textit{used for}} ([yshift=.2cm] I22.270);
	\draw[thick, double distance=2pt, -implies, in=270] (I23.270)+(-1.5,-1.2) to node[semithick, right, outer sep=0, pos=0.55]{\textit{used for}} ([yshift=.2cm] I23.270);
	\draw[thick, ->] (II1.0) to node[semithick, below, outer sep=0]{\textit{generalizes to}} (II2.180);
	\draw let \p{top}=(I1.90), \p{left}=(I21.180), \p{bottom}=([shift={(0,-.15)}]I22.270), \p{right}=(I23.0) in (\x{left}, \y{top}) -- (\x{left}, \y{bottom}) -- (\x{right}, \y{bottom}) -- (\x{right}, \y{top}) -- (\x{left}, \y{top});
	\draw let \p{top}=([shift={(0,.2)}]II1.90), \p{left}=(I21.180), \p{bottom}=(II1.270), \p{right}=(I23.0) in (\x{left}, \y{top}) -- (\x{left}, \y{bottom}) -- (\x{right}, \y{bottom}) -- (\x{right}, \y{top}) -- (\x{left}, \y{top});
	\path let \p{top}=(I1.90) in node[rectangle, draw, fill=white, align=left, inner sep=4] (I) at (-6.15, \y{top}) {\ref{part:geometry} -- Discrete geometry};
	\path let \p{top}=([shift={(0,.2)}]II1.90) in node[rectangle, draw, fill=white, align=left, inner sep=4] (I) at (-5.8, \y{top}) {\ref{part:algebra} -- Representation theory};
\end{tikzpicture}
}

%\centerline{
%\begin{tikzpicture}[every node/.style={inner sep=6, outer sep=8}]
% 	\node[cloud, cloud puffs=25, cloud ignores aspect, text width=5cm, minimum height=1cm, align=center, draw=blue, fill=blue!10, inner sep=3, outer sep=5] (I1) at (0,1.5) {\ref{part:geometry}.\ref{sec:typeCone} -- Simplicial type cone strategy};
%	\node[rectangle, draw=black, fill=black!10, align=center] (I21) at (-6,0) {\ref{part:geometry}.\ref{subsec:typeConeAsso} -- Toy example \\ Classical associahedra};
%	\node[rectangle, draw=orange, fill=orange!10, align=center, text width=5cm] (I22) at (-3,-1.5) {\ref{part:geometry}.\ref{subsec:typeConeCA} -- Cluster algebras \\ \& generalized associahedra};
%	\node[rectangle, draw=green, fill=green!10, align=center, text width=5cm] (I23) at (3,-1.5) {\ref{part:geometry}.\ref{subsec:typeConeNKC} -- Gentle algebras \\ \& generalized accordiohedra};
%	\node[rectangle, draw=red, fill=red!10, align=center, text width=5.4cm] (I24) at (7,0) {\ref{part:geometry}.\ref{subsec:typeConeGA} -- Graphical nested complexes \\ \& graph associahedra};
%	\node[ellipse, draw=orange, fill=orange!10, align=center, text width=4.9cm, inner sep=2, minimum height=1cm] (II1) at (-4.5,-4.2) {\ref{part:algebra}.\ref{sec:clusterCategories} -- Cluster categories};
%	\node[ellipse, draw=green, fill=green!10, align=center, text width=4.9cm, inner sep=0, minimum height=1cm] (II2) at (4.5,-4.2) {\ref{part:algebra}.\ref{sec:extricats} -- Extriangulated categories};
% 	\draw[decorate, decoration={shape backgrounds, shape=circle, shape size=2mm, shape evenly spread=8}, draw=blue, fill=blue!10] (I1.180) to [bend right, looseness=1.1] node[label={[shift={(.6,-1.5)}]applied to}]{} (I21.90);
% 	\draw[decorate, decoration={shape backgrounds, shape=circle, shape size=2mm, shape evenly spread=8}, draw=blue, fill=blue!10] (I1.240) to [bend right, looseness=.6] node[label={[shift={(.6,-1.5)}]applied to}]{} (I22.90);
% 	\draw[decorate, decoration={shape backgrounds, shape=circle, shape size=2mm, shape evenly spread=8}, draw=blue, fill=blue!10] (I1.300) to [bend left, looseness=.6] node[label={[shift={(-.6,-1.5)}]applied to}]{} (I23.90);
% 	\draw[decorate, decoration={shape backgrounds, shape=circle, shape size=2mm, shape evenly spread=10}, draw=blue, fill=blue!10] (I1.0) to [bend left, looseness=1.1] (I24.90);
% 	\draw[decorate, decoration={markings, mark=at position 0.5 with {\draw [red, ultra thick,-] ++ (-.3,-.3)  -- ( .3, .3); \draw [red, ultra thick,-] ++ (-.3, .3)  -- ( .3,-.3);}}] (I1.0) to [bend left, looseness=1.1] node[label={[shift={(-.4,-1.7)}]not applicable to}]{} (I24.90);
%	\draw[thick, double distance=2pt, -implies] (I22.270)+(0,-1.3) to node[semithick, right, outer sep=0, pos=0.65]{used for} (I22.270)+(0,.15);
%	\draw[thick, double distance=2pt, -implies] (I23.270)+(0,-1.3) to node[semithick, right, outer sep=0, pos=0.65]{used for} (I23.270)+(0,.15);
%	\draw[thick, ->] (II1.0) to node[semithick, above, outer sep=0]{generalizes to} (II2.180);
%	\draw let \p{top}=(I1.90), \p{left}=(I21.180), \p{bottom}=([shift={(0,-.15)}]I22.270), \p{right}=(I24.0) in (\x{left}, \y{top}) -- (\x{left}, \y{bottom}) -- (\x{right}, \y{bottom}) -- (\x{right}, \y{top}) -- (\x{left}, \y{top});
%	\draw let \p{top}=([shift={(0,.2)}]II1.90), \p{left}=(I21.180), \p{bottom}=(II1.270), \p{right}=(I24.0) in (\x{left}, \y{top}) -- (\x{left}, \y{bottom}) -- (\x{right}, \y{bottom}) -- (\x{right}, \y{top}) -- (\x{left}, \y{top});
%	\path let \p{top}=(I1.90) in node[rectangle, draw, fill=white, align=left, inner sep=4] (I) at (-6.15, \y{top}) {\ref{part:geometry} -- Discrete geometry};
%	\path let \p{top}=([shift={(0,.2)}]II1.90) in node[rectangle, draw, fill=white, align=left, inner sep=4] (I) at (-5.8, \y{top}) {\ref{part:algebra} -- Representation theory};
%\end{tikzpicture}
%}
...
\end{itemize}
A fan is \defn{simplicial} if all its cones are, \defn{complete} if the union of its cones covers the ambient space~$\R^d$, and \defn{essential} if it contains the cone~$\{\b{0}\}$. Note that every complete fan is the product of an essential fan with its lineality space.
...
Fix an essential complete simplicial fan~$\Fan$ in~$\R^n$. Let~$\b{G}$ be the $N \times n$-matrix whose rows are the rays of~$\Fan$ and let~$\b{K}$ be a $(N-n) \times N$-matrix that spans the left kernel of~$\b{G}$ (\ie $\b{K}\b{G} = 0$). For any height vector~$\b{h} \in \R^N$, we define the polytope
\[
...
Its type cone~$\typeCone(\Fan)$ lies in~$\R^5$, but has a $2$-dimensional lineality space.
...
We still consider an essential complete simplicial fan~$\Fan$ in~$\R^n$, the $N \times n$-matrix~$\b{G}$ whose rows are the rays of~$\Fan$, and an $(N-n) \times N$-matrix~$\b{K}$ that spans the left kernel of~$\b{G}$ (\ie $\b{K}\b{G} = 0$).
...
Note that~$\b{K}$ is only defined up to linear transformation, as it depends on the choice of a basis of the left kernel of~$\b{G}$. Note also that, by construction, the coefficients of the normal vectors of the facets of~$\typeCone(\Fan)$ arise from a linear dependence among the $\b{g}$-vectors, and hence belong to this kernel. When~$\typeCone(\Fan)$ is simplicial, its $(N-n)$ facets are necessarily linearly independent, and hence form a basis. They provide a particularly interesting choice of~$\b{K}$.  
...
\section{Applications to two generalizations of the associahedron}
...
Both families contain the classical associahedra~$\Asso[n]$ constructed in~\cite{ShniderSternberg, Loday}.
...
\item the intersection of the hyperplane~$\bigset{\b{x} \in \R^{n+1}}{\sum_{\ell \in [n+1]} x_\ell = \binom{n+2}{2}}$ with the halfspaces $\bigset{\b{x} \in \R^{n+1}}{\sum_{a < \ell < b} x_\ell \ge \binom{b-a}{2}}$ for all internal diagonals~$(a,b)$ of \mbox{the $(n+3)$-gon~\cite{ShniderSternberg}},
...
The type cone of~$\gvectorFan[2]$ lives in~$\R^5$ and has a lineality space of dimension~$2$ (this is the type cone studied in \cref{exm:typeCone,exm:typeConeCoarsenings,exm:typeConeMinkowskiSum}).
...
The type cone of~$\gvectorFan[3]$ lives in~$\R^9$ and has a lineality space of dimension~$3$.
...
% \arnau{Can you please check the coordinates? C.\ Stump thought that two facets had some typo (a $\pm 1$ was in the wrong column)}
...
The type cone of the left fan of \cref{fig:nonkissingFans} lives in~$\R^8$ and has a lineality space of dimension~$3$.
...
In~\cite{Auslander1984}, M.~Auslander showed that the relations in the Grothendieck group of an Artin algebra are generated by the ones given by almost-split sequences precisely when the algebra is of finite representation type.  This result was generalized to $\Hom{}$-finite, Krull-Schmidt exact categories with enough projectives by H.~Enomoto in~\cite{Enomoto}, and to $\Hom{}$-finite, Krull--Schmidt triangulated categories with a cogenerator by J.~Haugland in~\cite{Haugland}. Inspired by these results, we will show in this Section that a similar statement holds (see \cref{thm:relations-g-vecteurs}) for the~$\b{g}$-vectors (or indices) of objects in a~$2$-Calabi--Yau triangulated category.  We will further generalize these results in Section~\ref{sec:extricats} to the setting of Ext-finite, Krull-Schmidt, extriangulated categories with Auslander--Reiten--Serre duality admitting projective objects with certain properties.
...
The set of positive mesh mutations~$(x,x')$ of \cref{def:positive mutation} is in bijection with the set~$\meshes$ of \cref{def:positive mutation}.
\end{lemma}
...
%
% \begin{example}
%  Consider the preprojective algebra of type~$A_3$, as in \cref{exm:preprojective silting objects}. It is a self-injective algebra, so its module category is a Frobenius category. Its projective-injective objects are the modules 
%  \[
