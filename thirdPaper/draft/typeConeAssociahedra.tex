...
\begin{remark}
 Examples of categories satisfying the above properties are
 \begin{itemize}
  \item $2$-Calabi--Yau triangulaged categories admitting a cluster-tilting object (see Section~\ref{sect::2CYTriangulated});
...
%%
\subsubsection{Objects presented by a rigid object}
