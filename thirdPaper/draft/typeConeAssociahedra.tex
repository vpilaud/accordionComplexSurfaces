...
We are investigating in particular graph associahedra~\cite{CarrDevadoss, Postnikov, FeichtnerSturmfels, Zelevinsky}, brick polytopes~\cite{PilaudSantos-brickPolytope, PilaudStump-brickPolytope}\footnote{A preliminary version of this paper contained the full facet description of the type cones of graph associahedra. As they are not simplicial, they lie slightly beyond the scope of this paper, and will be studied elsewhere.} and quotientopes~\cite{Reading-latticeCongruences, Reading-CambrianLattices, PilaudSantos-quotientopes}.
