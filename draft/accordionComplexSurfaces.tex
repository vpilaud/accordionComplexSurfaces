...
Therefore, the corresponding surfaces have $1$ boundary component and genus~$(|Q_0|-1)/2$ when~$|Q_0|$ is odd, and $2$ boundary components and genus~$|Q_0|/2$ when~$|Q_0|$ is even.
...
\begin{figure}[h]
	\capstart
	\centerline{\includegraphics[scale=.7]{orderCurves}}
	\caption{The order~$\prec_\alpha$ is given by the order in which the curves cross the angle corresponding to~$\alpha$.}
