...
We can now define the non-kissing complex of a locally gentle bound quiver following~\cite{McConville, PaluPilaudPlamondon} (see also~\cite{BrustleDouvilleMousavandThomasYildirim}).
