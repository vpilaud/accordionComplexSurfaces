...
In this section, we define of three relevant families of vectors associated to walks in the non-kissing complex of a locally gentle quiver~$\bar Q$.
The $\b{g}$- and $\b{c}$-vectors were already considered for gentle algebras in~\cite[Sect.~4.2]{PaluPilaudPlamondon}, and their definition immediately generalizes to the case of locally gentle algebras.
...
\begin{proof}
Definitions~\ref{def: c-vectors for accordions} and~\ref{def: g-vectors for slaloms} are immediate translations in terms of curves on the surface~$\surface(\bar Q)$ of Definitions~\ref{def:cVectorsWalks} and~\ref{def:gVectorsWalks} respectively.
\end{proof}
