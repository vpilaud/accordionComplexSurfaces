...
Observe that~$\gvector{\omega} = 0$ for a straight walk~$\omega$, and that, since any infinite walk~$\omega$ is eventually cyclic, the coordinates of~$\gvector{\omega}$ are finite.
\end{definition}
