...
We first gather two technical lemmas on properties of oriented cycles of the quiver~$\bar Q$.
Note that oriented cycles were forbidden in the setting of gentle algebras studied in~\cite{PaluPilaudPlamondon}.
...
Consider a maximal non-kissing face~$F \in \NKC$.
We first argue that $F$ contains a walk distinct from~$c^\infty$ containing at least one arrow of~$c$.
\vincent{TODO}
