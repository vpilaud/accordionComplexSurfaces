...
\usepackage{enumerate, amsmath, amsfonts, amssymb, amsthm, mathrsfs, wasysym, graphics, graphicx, xcolor, url, hyperref, hypcap, xargs, multicol, pdflscape, multirow, hvfloat, array, ae, aecompl, pifont, mathtools, a4wide, float}
...
\newcommand{\vnext}{n} % next point on the boundary of the surface
\newcommand{\vprevious}{p} % previous point on the boundary of the surface
