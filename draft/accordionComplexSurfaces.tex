...
The non-kissing complex~$\NKC$ and the non-crossing complex~$\NCC[\dissection_{\bar Q}, {\dissection_{\bar Q}}\dual]$ are pure of dimension~$3|Q_0| - |Q_1| + p$ where~$p$ is the number of oriented cycles in~$\bar Q$ or equivalently the number of punctures in~$\surface_{\bar Q}$.
\end{proposition}
...
If~$\lambda$ starts or ends by~$c^\infty$, then we have found a walk of the desired form.
