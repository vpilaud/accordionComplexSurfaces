...
We conclude this section with four families of examples.
...
On the surface~$\surface_{\bar Q}$, the dual dissections~$\dissection$ and~$\dissection\dual$ are as on \fref{fig:kissingVSCrossing} (on the right hand side).
...
If we force all $\dissection$-accordions (or $\dissection\dual$-slaloms) to cross the edges of~$\dissection$ and~$\dissection\dual$ only at these intersection points, then an $\dissection$-accordion (or $\dissection\dual$-slalom) is really seen a walk on~$\bar Q$.
\end{remark}
