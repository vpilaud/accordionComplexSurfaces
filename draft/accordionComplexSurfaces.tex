...
The following proposition appears implicitly in \cite{OpperPlamondonSchroll}.
...
\vincent{TODO: surfaces double cycles.}
\end{example}
...
The following definition from \cite[Definition 2.23]{PaluPilaudPlamondon} extends to the setting of locally gentle algebras.
...
\end{proposition}
\begin{proof}
 \vincent{Vincent has the proof of this proposition.}
