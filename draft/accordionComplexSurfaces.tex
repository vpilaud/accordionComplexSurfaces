...
\begin{definition}
\label{def:accordion}
A \defn{$\dissection$-accordion} is an arc~$\gamma$ of~$(\surface, B)$ such that whenever~$\gamma$ crosses a face~$f$ of~$\dissection$, it crosses two edges of~$f$ that share a marked point of~$v \in M$ in such a way that~$v$ and~$f\dual$ lie on opposite sides of~$\gamma$.


% the two edges of~$f$ crossed by~$\gamma$ share a marked point~$v \in M$, and~$v$ and~$f\dual$ are on opposite sides of~$\gamma$ in~$f$.
% any two arcs of $\dissection$ crossed consecutively by~$\gamma$ share a marked point with the property that the region bounded by~$\gamma$ and the two arcs around the marked point does not contain.
\end{definition}
...
\vincent{Reduced slalom complex.}
\end{definition}
...
\begin{remark}
A quick disclaimer about accordion complexes and slalom complexes of arbitrary dissections, non-necessarily cellular.
