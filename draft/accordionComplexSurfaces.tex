...
\pierreguy{Remark on the comparison with the surface of OPS}
...
\begin{proof}
See \fref{fig:kissings} and \fref{fig:kissingVSCrossing}.
\pierreguy{Complete this proof using the pictures.}
...
\begin{proposition}
\label{prop:purity}
The non-kissing complex~$\NKC$ and the non-crossing complex~$\NCC[\dissection_{\bar Q}, {\dissection_{\bar Q}}\dual]$ are pure of dimension~$3|Q_0| - |Q_1|$.
\vincent{This is wrong. We need to count the infinite straight walks. I propose the next statement instead.}
\end{proposition}
