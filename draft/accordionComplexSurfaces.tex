...
\end{itemize}
We also define~${}^{-\infty}c \eqdef (c^\infty)^{-1}$ and similarly~$c^{-\infty} \eqdef (^\infty c)^{-1}$.
\end{notation}
...
\vincent{We also want $c_1\sigma \notin I$ or $c_1^{-1} \notin I$ depending on what we have...}
...
\begin{remark}
 The terminology in the previous definition is borrowed from~\cite{Crawley-Boevey}.
