...
The duality between~$\b{g}$-vectors and~$\b{c}$-vectors then follows from the duality between the two dissections~$\dissection_Q$ and~$\dissection\dual_Q$.
...
The the~$\b{g}$-vector of the walk~$\omega$ coincide with the~$\b{g}$-vector of the (finitely generated) string module associated with the string~$\sigma$.
\end{remark}
