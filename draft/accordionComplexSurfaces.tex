...
\item The number of boundray components of~$\surface(\bar Q)$ can be computed as follows.
...
For any finite face~$F$ of~$\NKC$ and any arrow~$\alpha\in Q_1\blossom$, the set~$F_\alpha$ admits a maximal element for the countercurrent order~$\prec_\alpha$.
\end{lemma}
\begin{proof}
