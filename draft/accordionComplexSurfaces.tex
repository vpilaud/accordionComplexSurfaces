...
In this section, we show that the non-kissing complex is a \defn{pseudomanifold},~\ie
\begin{enumerate}[(i)]
\item \defn{pure}: all maximal non-kissing simplices have the same number of walks as~$\dissection$, and
\item \defn{thin}: any codimension~$1$ simplex of~$\NKC$ is contained in exactly two maximal non-kissing simplices.
\end{enumerate}
