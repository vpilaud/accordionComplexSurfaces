...
\title{Test : Accordion complexes versus non-kissing complexes}
...
\subsection{Accordions and zigzags}
...
\begin{definition}
\label{def:accordion}
A \defn{$\dissection$-accordion} is ...
\end{definition}

\begin{definition}
\label{def:zigzag}
A \defn{$\dissection\dual$-zigzag} is ...
\end{definition}
...
\begin{remark}
The $\dissection$-zigzags and the $\dissection\dual$-accordions are defined dually.
\end{remark}
