...
Then~$\gamma \prec_\alpha \delta$ if~$\gamma$ passes closer to~$v$ (resp.~further to~$v\dual$) than~$\delta$ does.
...
For a vertex~$v \in Q_0$, the $v$-th entry of the $\b{c}$-vector~$\cvector{\omega}{F}$ is up to the sign given by:
\begin{enumerate}[(i)]
