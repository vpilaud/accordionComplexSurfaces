...
\title{Accordion / zigzag / non-kissing / support $\tau$-tilting complexes all coincide}
...
\section{Accordion complex and zigzag complex}
...
\subsection{Accordion complex and zigzag complex}
...
\section{All complexes coincide}
...
\begin{proposition}
\label{prop:dualityKozul1}
For two dual dissections~$\dissection$ and~$\dissection\dual$ of an oriented surface, the quivers~$\bar Q(\dissection)$ and~$\bar Q(\dissection\dual)$ are Kozul duals.
\end{proposition}
...
The surface~$\surface(\bar Q)$ of a gentle bound quiver~$\bar Q = (Q,I)$ is obtained by glueing lozanges around arrows of~$Q$ following the rule given by the relations~$I$. The construction also automatically defines two dual dissections~$\dissection(\bar Q)$ and~$\dissection\dual(\bar Q)$ of the surface~$\surface(\bar Q)$.
\end{definition}

\begin{proposition}
\label{prop:dualityKozul2}
For any gentle bound quiver~$\bar Q$ with Kozul dual~$\bar Q\dual$, the surfaces~$\surface(\bar Q)$ and~$\surface(\bar Q\dual)$ coincide, but~$\dissection(\bar Q\dual) = \dissection\dual(\bar Q)$ and~$\dissection\dual(\bar Q\dual) = \dissection(\bar Q)$.
\end{proposition}
...
\begin{itemize}
\item For any gentle bound quiver~$\bar Q$, the non-kissing complex~$\NKC$ is isomorphic to the accordion complex~$\AC[\dissection(\bar Q)]$ and to the zigzag complex~$\ZC[\dissection\dual(\bar Q)]$.
\item For any pair of dual dissections~$\dissection, \dissection\dual$ of an oriented surface, the accordion complex~$\AC$ and the zigzag complex~$\ZC$ are isomorphic to the non-kissing complex~$\NKC[\bar Q(\dissection)]$.
\end{itemize}
\end{theorem}
