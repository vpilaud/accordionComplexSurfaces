...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{From walks on a grid [T. McConville]...}{name=walks,column=0,span=3,row=0,borderColor=green,headerColorOne=green}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% 
% \hspace{5.7cm}
% % \includegraphics[scale=.65]{flip1} \hspace{-.5cm} \raisebox{.6cm}{$\longrightarrow$} \hspace{.1cm} \includegraphics[scale=.65]{flip2}
% 
% \vspace{-1.5cm}
% \begin{minipage}{6cm}
...
% \end{minipage}
\medskip
{\color{green} \bf Theorem} [PPP]: {\it The reduced non-kissing complex of any gentle}
\hspace*{2.7cm}{\it bound quiver is pure and thin.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Accordions on a disk [Manneville--Pilaud]}{name=accordions,column=0,span=3,below=walks,borderColor=blue,headerColorOne=blue}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\hspace*{6cm}\includegraphics[scale=.17]{DissectionAccordions}
...
{\color{blue} \bf Theorem} [MP]: {\it The reduced non-crossing complex is pure and thin.}


}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Accordions on a Riemann surface [PPP]}{name=PPP2,column=3,span=3,below=PPP1,borderColor=blue,headerColorOne=blue}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{\color{blue} \bf Theorem:} {\it The reduced non-crossing complex is pure and thin.}
...
\hspace*{6cm}\includegraphics[scale=.2]{QuiverOfADissection}
...
{\color{red} \bf Proposition:} {\it The bound quiver associated with any dualizable} \hspace*{2.3cm}{\it dissection of a marked surface is gentle.}
}
...
{\color{red} \bf Proposition:} {\it The construction above yields a marked surface endowed with a pair of dual dissections; given by green arcs / red arcs.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Main Results}{name=polytopes,column=0,span=3,below=Dissection2Gentle,borderColor=red,headerColorOne=red}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

{\color{red} \bf Theorem:} {\it The two constructions above induce bijections between (isomorphism classes of) gentle bound quivers and (homeomorphism classes of) marked oriented surfaces with boundary endowed with a pair of dual dissections.}
...
{\color{red} \bf Theorem:} {\it
There is an expicit bijection between walks on $(Q,I)$ and accordions on the associated surface $S$, such that two walks kiss if and only if the associated accordions cross.
In particular, the non-kissing complex of $(Q,I)$ is isomorphic to the non-crossing complex of $S$.
}
}
