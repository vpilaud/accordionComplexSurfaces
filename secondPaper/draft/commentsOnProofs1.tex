...
\begin{enumerate}
 \item There appears to be a problem with the default value of several of the \verb|\newcommandx|: in many places, the characters ``\verb|1 = |'' appear, and they should not.  Here is a list of such instances.
   \begin{itemize}
    ...
    \item p.32, l.-2: ``$\RNKC[1=\bar Q]$'' should be ``$\RNKC$''.
    \item p.32, l.-2: ``$\allcvectors[1=\bar Q]$'' should be ``$\allcvectors$''.
    \item p.32, l.-1: ``$\RNKC[1=\bar Q]$'' should be ``$\RNKC$''.
    \item p.33, Figure 29: ``$\RAC[1=\dissection]$'' should be ``$\RAC$''.
    \item p.33, Figure 29: ``$\RSC[1=\dissection\dual]$'' should be ``$\RSC$''.
    \item p.34, l.20: ``$\RNKC[1=\bar Q]$'' should be ``$\RNKC$''.
    \item p.35, l.4: ``$\RNKC[1=\bar Q]$'' should be ``$\RNKC$''.
    \item p.35, l.12: ``$\RNKC[1=\bar Q]$'' should be ``$\RNKC$''.
    \item p.35, l.-12: ``$\NKC[1=\bar Q]$'' should be ``$\NKC$''.
    \item p.35, l.-10: ``$\gvectorFan[1=\bar Q]$'' should be ``$\gvectorFan$''.
    \item p.35, l.-10: ``$\RNKC[1=\bar Q]$'' should be ``$\RNKC$''.
    \item p.35, l.-6: ``$\RNKC[1=\bar Q]$'' should be ``$\RNKC$''.
    \item p.36, Figure 30: ``$\gvectorFan[1=\bar Q]$'' should be ``$\gvectorFan$''.
   \end{itemize}
