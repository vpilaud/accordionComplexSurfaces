...
Given a gentle bound quiver $Q$, take its blossoming, then glue a green (resp.~red) triangle to the left (resp.~right) of each arrow.
...
{\color{red} \bf Thm:} {\it
Walks on $Q$ $\longleftrightarrow$ accordions on the associated surface $S$

\hspace*{1.64cm}kissing $\longleftrightarrow$ crossing

\hspace*{1.05cm}non-kissing complex of $Q$ $\cong$ non-crossing complex of $S$.
}
}
