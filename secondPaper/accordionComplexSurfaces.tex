...
We note that our dissections are always cellular, while those found in \cite{BaurCoelhoSimoes} can be arbitrary.
...
The following definition generalises the one from \cite{MannevillePilaud-accordion} for the case where~$\bar \surface$ is a disk.  A very similar definition appears in \cite{BaurCoelhoSimoes} in a slightly different context under the name ``permissible~arc''.
